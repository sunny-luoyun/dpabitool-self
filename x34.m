function x34(path, factor1, factor2, level1, level2)
% 定义包含所有子文件夹的路径
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(4).levels = [1
                                                                    4];
% 定义基础路径
base_path = fullfile(path,first{1},second{4});
...
list_combined = cellfun(@(x) [x{1}, x{2}], list, 'UniformOutput', false);
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(7).scans = list_combined;
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(8).levels = [2
                                                                    4];
% 定义基础路径
base_path = fullfile(path,first{2},second{4});
...
list_combined = cellfun(@(x) [x{1}, x{2}], list, 'UniformOutput', false);
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(8).scans = list_combined;

atlabbatch{1}.spm.stats.factorial_design.des.fd.icell(9).levels = [3
                                                                   1];
% 定义基础路径
base_path = fullfile(path,first{3},second{1});
...
list_combined = cellfun(@(x) [x{1}, x{2}], list, 'UniformOutput', false);
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(9).scans = list_combined;

atlabbatch{1}.spm.stats.factorial_design.des.fd.icell(10).levels = [3
                                                                    2];
% 定义基础路径
base_path = fullfile(path,first{3},second{2});
...
list_combined = cellfun(@(x) [x{1}, x{2}], list, 'UniformOutput', false);
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(10).scans = list_combined;

atlabbatch{1}.spm.stats.factorial_design.des.fd.icell(11).levels = [3
                                                                    3];
% 定义基础路径
base_path = fullfile(path,first{3},second{3});
...
list_combined = cellfun(@(x) [x{1}, x{2}], list, 'UniformOutput', false);
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(11).scans = list_combined;

atlabbatch{1}.spm.stats.factorial_design.des.fd.icell(12).levels = [3
                                                                    4];
% 定义基础路径
base_path = fullfile(path,first{3},second{4});
...
list_combined = cellfun(@(x) [x{1}, x{2}], list, 'UniformOutput', false);
%%
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(12).scans = list_combined;
